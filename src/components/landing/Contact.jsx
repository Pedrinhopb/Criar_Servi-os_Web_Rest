        ...
        <div>
          ...
          <div className={styles.grid}>
            <form className={styles.form} onSubmit={handleSubmit}>
              ...
              <textarea className={styles.textarea} name="message" rows="5" value={form.message} onChange={handleChange} required />
            ...
            <div className={styles.infoBox}>
              ...
              <div className={styles.infoItem}><span>📧</span><div><strong>E-mail</strong><p>contato@stockeasy.com.br</p></div></div>
              <div className={styles.infoItem}><span>💬</span><div><strong>WhatsApp</strong><p>(83) 9 9999-0000</p></div></div>
              <div className={styles.infoItem}><span>🕐</span><div><strong>Horário</strong><p>Seg a Sex, 8h às 18h</p></div></div>
            </div>
          </div>
        </div>
      </div>
